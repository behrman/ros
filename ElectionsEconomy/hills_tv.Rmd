...
This plot displays the likelihood for a simple example as a function of the coefficients a and b. Strictly speaking, this model has three parameters -- a, b, and $\sigma$ -- but for simplicity we display the likelihood of a and b conditional on the estimated $\hat{\sigma}$.
